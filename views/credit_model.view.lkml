view: credit_model {
  sql_table_name: `loans.CreditModel`
    ;;
  ...
  measure: sum_paid_installments {
    type: sum
    sql: ${TABLE}.no_of_paid_installments ;;
  }
  measure: sum_missed_installments {
    type: sum
    sql: ${TABLE}.no_of_missed_installments ;;
  }
  measure: Paid_Installments{
    type: number
    sql: ${sum_paid_installments}/(${sum_paid_installments}+${sum_missed_installments});;
  }
  measure: Missed_Installments{
    type: number
    sql: ${sum_missed_installments}/(${sum_paid_installments}+${sum_missed_installments});;
  }
}
